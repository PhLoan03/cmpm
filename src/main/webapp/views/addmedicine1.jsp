...
<link rel="stylesheet" href="../styles/styleadd1.css">
	...
	<div id="container">
		...
		<form action="prescription.jsp">
			...
			<div>
				...
				<input type="submit" style="position: relative;left: 620%; width: 160px;
    margin: 0 auto;
    height: 50px;
    gap: 20px;
    flex-shrink: 0;
